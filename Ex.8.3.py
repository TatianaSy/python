...
class NotNumbErr:
    ...
    def my_input(self):
        ...
        while True:
            val = input('Введите данные или  нажмите q для выхода - ')
            if val == 'q':
                break
                #при нажатии q почему-то выход не произодится

            try:
                self.my_list.append(float(val))
                print(f'Текущий список - {self.my_list} \n ')
            except:
                print(f"Недопустимое значение: вводите только числа!")
