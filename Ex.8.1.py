...
today = Data('15 - 4 - 2021')
print(today)
print(Data.valid(6, 10, 2022))
print(today.valid(11, 8, 2021))
print(Data.extract('01 - 09 - 2020'))
print(today.extract('15 - 04 - 2021'))
print(Data.valid(3, 8, 2020))
